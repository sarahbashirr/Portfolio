...
// ✅ FIXED: Moved projects OUTSIDE the component so it's declared before use
const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Motivio is a user-centered web application designed to help individuals stay motivated and productive by tracking goals, maintaining consistency, and building better habits.',
...
const Portfolio = () => {
  ...
  const handleDownloadCV = () => {
    ...
    link.href = '/pdfs/SarahBashirCV.pdf';
      ...
      <section id="skills" className="py-20 px-4 bg-gray-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {[
                'React', 'Next.js', 'TypeScript', 'Laravel', 'Firebase', 
                'MySQL', 'HTML', 'CSS', 'Tailwind CSS', 'C++', 'C',
                'Figma', 'Adobe Illustrator', 'Adobe Photoshop', 'Azure'
              ].map((tech, index) => (
                <span
                  key={index}
          ...
          <div className="bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-gray-700">
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                {/* ✅ FIXED: category is array, join for display */}
